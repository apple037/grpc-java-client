...
@Configuration
public class RustServerChannel {

  @Value("${grpc.channel.rust-server.address}")
  private String grpcAddress;

  @Value("${grpc.channel.rust-server.port}")
  ...
  @Bean("rustServerGrpcChannel")
  public ManagedChannel rustServerGrpcChannel() {
